...
# Flood mask: elevation < 1500 m
flood_mask = (z < 1500).astype(int)
...
grid.point_data["Flood <1500m"] = flood_mask.ravel(order="F")

# Plotting
plotter = pv.Plotter()
plotter.set_background("white")
plotter.add_mesh(grid, scalars="Flood <1500m", cmap=["white", "blue"], show_scalar_bar=False)
plotter.add_text("Flood Risk Areas (<1500m)", font_size=12)
