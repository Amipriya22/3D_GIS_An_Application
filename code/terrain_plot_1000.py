...
grid.point_data["Flood <1000m"] = flood_mask.ravel(order="F")

# Plotting
plotter = pv.Plotter()
plotter.set_background("white")
plotter.add_mesh(grid, scalars="Flood <1000m", cmap=["white", "blue"], show_scalar_bar=False)
plotter.add_text("Flood Risk Areas (<1000m)", font_size=12)
