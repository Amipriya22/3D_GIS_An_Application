...
# Flood mask: elevation < 2000 m
flood_mask = (z < 2000).astype(int)
...
grid.point_data["Flood <2000m"] = flood_mask.ravel(order="F")

# Plotting
plotter = pv.Plotter()
plotter.set_background("white")
plotter.add_mesh(grid, scalars="Flood <2000m", cmap=["white", "blue"], show_scalar_bar=False)
plotter.add_text("Flood Risk Areas (<2000m)", font_size=12)
